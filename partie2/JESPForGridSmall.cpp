...
JESPForGridSmall::JESPForGridSmall(
    int horizon,
...
double JESPForGridSmall::DynamicProgrammingBestResponse(
...
double JESPForGridSmall::DPBestResponseRecursively
    (
...
void JESPForGridSmall::ConstructPolicyRecursively
    (
     const Index agentI, //the agent we are computing the best response for

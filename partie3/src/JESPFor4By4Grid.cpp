...
JESPFor4By4Grid::JESPFor4By4Grid(
    int horizon,
...
double JESPFor4By4Grid::DynamicProgrammingBestResponse(
...
double JESPFor4By4Grid::DPBestResponseRecursively
    (
...
void JESPFor4By4Grid::ConstructPolicyRecursively
    (
     const Index agentI, //the agent we are computing the best response for
